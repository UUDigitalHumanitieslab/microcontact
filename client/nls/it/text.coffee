...
otherLanguagesPlaceholder: 'nessuna'
...
movedNeverLabel: 'Ho sempre vissuto a {{name}}.'
movedWithinItalyLabel: 'Mi sono trasferito a {{name}}.'
movedFromLabel: 'Mi sono trasferito da'
placeOfOriginPlaceholder: 'Città di origine'
movedInYearLabel: 'nell’anno'
